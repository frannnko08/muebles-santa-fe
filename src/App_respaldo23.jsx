        ...
        {tab==="control_calidad" && esAdmin && (
          <div>
            <div style={{ display:"flex", justifyContent:"space-between", alignItems:"center", marginBottom:20, gap:12 }}>
              ...
              <button
                onClick={() => alert("Próximamente: formulario para registrar nuevos errores")}
                style={{
                  background:COLORS.success,
                  border:"none",
                  color:"#fff",
                    ...
                    {erroresProduccion.map((err) => (
                      <tr key={err.id} style={{ background:COLORS.card, borderBottom:`1px solid ${COLORS.border}` }}>
                        ...
                        <td style={{ padding:10, textAlign:"center" }}>
                          <button
                            onClick={() => toast("Próximamente: editar error", "info")}
                            style={{ background:"none", border:"none", color:COLORS.muted, cursor:"pointer", fontSize:14 }}
                          >
                            ✏️
                          </button>
                          <button
                            onClick={() => toast("Próximamente: eliminar error", "info")}
