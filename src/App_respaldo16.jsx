...
function PreviewOCModal({ productos, onClose, onConfirm }) {
  ...
  const confirmar = () => {
    if (!documento.trim()) {
      alert("Debes ingresar el número de factura u orden de compra para evitar duplicados.");
      return;
    }
...
const confirmarImportacionOC = async (datosCompra = {}) => {
  ...
  if (!documentoCompra) {
    alert("Debes ingresar el número de factura u orden de compra antes de importar. Esto evita duplicar stock por error.");
    return;
  }
      ...
      <div style={{
        ...
        <div style={{ display:"flex", justifyContent:"space-between", alignItems:"center", gap:10, marginBottom:10 }}>
          <div>
            ...
            <p style={{ margin:0, color:COLORS.muted, fontSize:12 }}>
              Registro anti-duplicados, mayor a menor
            </p>
          </div>
        ...
        {ordenesCompraImportadas.length === 0 ? (
          <div style={{ color:COLORS.muted, fontSize:13 }}>
            Todavía no hay OC registradas como importadas.
          </div>
        ) : (
          <div style={{ display:"grid", gap:8 }}>
            {ordenesCompraImportadas.map((doc, idx) => (
              ...
              >
                ...
                <span style={{ color:COLORS.text, fontSize:12, overflow:"hidden", textOverflow:"ellipsis", whiteSpace:"nowrap" }}>
